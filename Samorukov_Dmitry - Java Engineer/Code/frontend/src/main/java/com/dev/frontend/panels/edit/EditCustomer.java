...
public class EditCustomer extends EditContentPanel 
{
	...
	public boolean bindToGUI(Object o) 
	{
		...
		txtName.setText(params.get("name").toString());
		txtPhone1.setText(params.get("phone1").toString());
		txtPhone2.setText(params.get("phone2").toString());
		txtAddress.setText(params.get("address").toString());
		txtCreditLimit.setText(params.get("creditLimit").toString());
		txtCurrentCredit.setText(params.get("currentCredit").toString());
		return false;
	}
	...
	public Object guiToObject() 
	{
		...
		ret.put("name", txtName.getText());
		ret.put("phone1", txtPhone1.getText());
		ret.put("phone2", txtPhone2.getText());
		ret.put("address", txtAddress.getText());
		ret.put("creditLimit", txtCreditLimit.getText());
		ret.put("currentCredit", txtCurrentCredit.getText());
		return ret;
	}
